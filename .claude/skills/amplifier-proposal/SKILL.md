...
- No page carries Amit's name, a byline or a "prepared by" line
- `layout_check()` returns clean: no margin overruns, no leading under 1.30x, no
  uneven leading in a column, no crowded or lopsided card padding. Visual review is
  in addition to this check, never instead of it
