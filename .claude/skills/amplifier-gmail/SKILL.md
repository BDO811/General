...
## Step 4 — Verify CEO email (MANDATORY — 3 sources)
...
3. Cross-reference the specific CEO email across 3+ sources
4. If all 3 agree: mark CONFIRMED. If sources conflict: use most authoritative (ZoomInfo > RocketReach) and note as flag.
